# 基于Ansible脚本部署Kubernetes v1.18 高可用集群
### 一、安装要求   
...
![single-master](https://ecblog.oss-cn-hangzhou.aliyuncs.com/single-master.jpg)
...
![image-20200718230920066](https://ecblog.oss-cn-hangzhou.aliyuncs.com/image-20200718230920066.png)
...
![image-20200718231233862](https://ecblog.oss-cn-hangzhou.aliyuncs.com/image-20200718231233862.png)

进入页面后，点击左侧导航栏Nodes，可以看到目前加入k8s的服务器节点。

![image-20200718231355987](https://ecblog.oss-cn-hangzhou.aliyuncs.com/image-20200718231355987.png)
...
![image-20200718232547965](https://ecblog.oss-cn-hangzhou.aliyuncs.com/image-20200718232547965.png)

可以看到测试用的web容器已经启动，查看容器日志

![image-20200718232658162](https://ecblog.oss-cn-hangzhou.aliyuncs.com/image-20200718232658162.png)

浏览器访问：http://10.10.10.9:30794/

![image-20200718232858065](https://ecblog.oss-cn-hangzhou.aliyuncs.com/image-20200718232858065.png)
